  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        ...
        const viewerParam = currentUser?.username
          ? `?viewer=${encodeURIComponent(currentUser.username)}`
          : "";
        const response = await fetch(
          `${API_URL}/users/${username}${viewerParam}`
        );
        ...
        setFollowerCount(
          typeof profileWithDefaults.followerCount === "number"
      ...
      <div style={styles.mainContent}>
          ...
          <div style={styles.headerTop}>
            ...
            <div
              style={{
                ...
                backgroundPosition: "center",
                fontSize:
                  avatarPreview || profileData.profile.avatar ? "0" : "40px",
                display: "flex",
                alignItems: "center",
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={styles.cakeDay}>
                Cake Day:{" "}
                {new Date(
                  profileData.profile.cakeDay || new Date()
                ).toLocaleDateString()}
              </div>

              {/* Followers Count */}
              <div
                style={{ marginTop: "6px", color: "#d7dadc", fontSize: "13px" }}
              >
                Followers:{" "}
                <strong style={{ color: "#ffffff" }}>{followerCount}</strong>
              </div>
          ...
          {isEditing ? (
            <>
              ...
              <div style={styles.buttonGroup}>
                <button onClick={handleSaveBio} style={styles.saveBtn}>
                  Save
                </button>
                <button
        ...
        {profileData.role === "admin" && (
          <div style={{ marginTop: "20px" }}>
            ...
            {adminActions.length === 0 ? (
              <div style={{ color: "#818384", fontSize: "13px" }}>
                ...
                {adminActions.map((act) => (
                  ...
                  >
                    <div style={{ fontSize: "13px", color: "#d7dadc" }}>
                      ...
                      {act.targetType} — {act.targetSummary}
                    </div>
        ...
        <div style={styles.tabsContainer}>
          ...
          <button
            style={{
              ...styles.tabBtn,
              ...(activeTab === "comments" ? styles.tabBtnActive : {}),
            }}
                  ...
                  <span style={styles.commentMeta}>
                    ...
                    <span style={styles.communityName}>
                      ...
                      {comment.post?.community
                        ? comment.post.community.startsWith("r/")
                          ? comment.post.community.substring(2)
                          : comment.post.community
                        : ""}
                    </span>
                    <span style={styles.metaDivider}>•</span>
